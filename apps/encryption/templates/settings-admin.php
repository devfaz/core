...
<form id="ocDefaultEncryptionModule" class="sub-section">
	...
	<?php else: ?>
		<p id="encryptHomeStorageSetting">
			<input type="checkbox" name="encrypt_home_storage" id="encryptHomeStorage"
			...
			<em><?php p( $l->t( "Enabling this option encrypt all files stored on the main storage, otherwise only files on external storage will be encrypted" ) ); ?></em>
		</p>
		<br />
